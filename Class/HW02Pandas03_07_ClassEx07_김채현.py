...
class SafeFourCal(FourCal):
	def div(self):#현재 메소드 우선
		if self.second==0:
			...
			return super().div()
			#super(상위클래스) 상위클래스의 div를 구현하라
a=SafeFourCal(4,3) #상속


print(a.first,'+',a.second,'=',a.sum())#4+3=4
print(a.first,'-',a.second,'=',a.sub())#4-3=4
print(a.first,'*',a.second,'=',a.mul())#4*3=0
print(a.first,'/',a.second,'=',a.div())#4/3=0
